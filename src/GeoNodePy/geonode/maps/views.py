...
class LayerForm(forms.ModelForm):
    ...
    class Meta:
        model = Layer
        exclude = ('owner', 'contacts','workspace', 'store', 'name', 'uuid', 'storeType', 'typename', 'keywords_region', 'language', 'bbox', 'llbbox', 'srs', 'geographic_bounding_box', 'distribution_url', 'distribution_description' )
