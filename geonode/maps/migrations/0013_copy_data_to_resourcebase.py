...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Loop through all existing maps
        for map in orm.Map.objects.all():

            # Create a new resourcebase for the map
            map.resourcebase_ptr = orm['base.ResourceBase'].objects.create()

            # Copy data to the linked resourcebase; these fields are deleted in migration 0014
            map.resourcebase_ptr.abstract = map.abstract
            map.resourcebase_ptr.owner = map.owner
